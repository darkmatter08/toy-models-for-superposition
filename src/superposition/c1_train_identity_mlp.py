...
from src.superposition.mlp_net import IdentityMLP
...
if __name__ == '__main__':
    ...
    for sparsity in sparsity_list:
        ...
        two_w_net_folder_path_str = f'src/superposition/weights/mlp/s_{sparsity}'

        folder_path = Path(two_w_net_folder_path_str)
        folder_path.mkdir(parents=True, exist_ok=True)

        two_w_net_name = 'mlp'
        print("Training IdentityMLPNet with sparsity: ", sparsity)
